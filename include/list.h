 ...
 */
struct List * List_Create(int mode, 
        int (*cmp)(void *, void *), 
 ...
 */
bool List_Push(struct List *list, void *item);
 ...
 */
void * List_Find(struct List *list, void *id);
 ...
 * @return true on success, false on error.
 */
bool List_ForEach(struct List *list, int (*op)(void *i, void *ud), void *userData);
 ...
 * @return A new list on success, NULL on error.
 */
struct List* List_Clone (struct List *source);
